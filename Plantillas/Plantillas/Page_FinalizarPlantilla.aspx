...
//            });
    ...
    <div id="DivCorreos" runat="server" style="display:none; width: 480px; position:absolute; top: 220px; left: 155px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="BACKGROUND-COLOR: highlighttext" align="center" colspan="2">
                                    ...
                                    <asp:Label id="LblMessageBox2" runat="server" Width="1px" Font-Size="XX-Small"  Height="1px" ForeColor="Red">
                                    </asp:Label>
                                </td>
                            </tr>
                        </tbody>
