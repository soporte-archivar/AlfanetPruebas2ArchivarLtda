...
public partial class AlfanetDocumentos_DocEnviado_NuevoDocEnviadoInt : System.Web.UI.Page
{
    string WFAccion = "2";
    string GrpDocReg = "2";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Admon == "S")
                {
                    ((MasterPage)this.Master).hidemenu();
                }
                else
                {
                    ((MasterPage)this.Master).showmenu();
                }
    ...
    //    {
    //        this.AutoCompleteExpediente.ServiceMethod = "GetProcedenciaByTextNombre";
    //        this.TxtExpediente.Text = "";
    //    }
    //    else if (RadioButtonList3.SelectedValue == "1")
    //    {
    //        this.AutoCompleteExpediente.ServiceMethod = "GetProcedenciaByTextId";
    //        this.TxtExpediente.Text = "";
    //    }
    //}
    ...
    {
        Session["CodRegistro"] = string.Empty;
        ...
        try
        {
            ...
            if (RadioButtonList1.SelectedValue == "1")
            {
                ...
                int registro = Convert.ToInt32(RegistroCodigo);
                Regi = Registro.GetData(registro);
                string Detalle = Regi.Rows[0].ItemArray[0].ToString().Trim();
                if (DTUsuariosxDependencia.Count > 0)
                {
                    ...
                    string Body = "Tiene un nuevo Registro Nro " + RegistroCodigo + "<BR>" + " Fecha de Tramite: " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "<BR>" + "Dependencia: " + this.TxtDependencia.Text.ToString() + "<BR>" + "Naturaleza: " + this.TxtNaturaleza.Text.ToString().Trim() + "<BR>" + "Detalle: " + Detalle + "<BR>";
        ...
        catch (Exception Error)
        {
           	this.Label11.Visible = false;
            this.Label10.Visible = false;
            this.ExceptionDetails.Text = "El Registro no se guardo. Verifique por favor ";
    ...
    protected void cmdCancel_Click(object sender, ImageClickEventArgs e)
    {
        ...
        catch (Exception Error)
        {
            	this.Label11.Visible = false;
            this.Label10.Visible = false;
            this.ExceptionDetails.Text = "El Registro no se cancelo. Verifique el número por favor ";
            //this.ExceptionDetails.Text += ErrorHandled.FindError(Error);
            //this.ExceptionDetails.Text = "Problema" + Error;
        }
    }
    ...
    protected void cmdActualizar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        catch (Exception Error)
        {
			this.Label11.Visible = false;
            this.Label10.Visible = false;
            this.ExceptionDetails.Text = "El Registro no se actualizo. Verifique el número por favor ";
            //this.ExceptionDetails.Text += ErrorHandled.FindError(Error);
            //this.ExceptionDetails.Text = "Problema" + Error;
        }
    }
    ...
    protected void ImgBtnAddFuente_Click(object sender, ImageClickEventArgs e)
    {
		...
		//this.ListBoxFuente.Items.Add(this.DropDownListGrupoFuente.SelectedValue.Trim() + "--" + this.TxtRadFuente.Text.Trim() + this.TxtDestino.Text.Trim());
    ...
    protected void ImgBtnFindRad_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            DataTable DTRadFuente = ejecutar.rtn_traer_radicadofuente_por_grupo_por_id(Grupo, Convert.ToInt64(NroReg));
        ...
        catch (Exception Error)
        {
            ...
            this.Label11.Visible = false;
            this.Label10.Visible = false;
            this.ExceptionDetails.Text = "El Registro no existe. Verifique el número por favor ";
            //this.ExceptionDetails.Text += ErrorHandled.FindError(Error);
        }
    }
    ...
    protected void insertarradicadosfuente(string RegistroCodigo)
    {
        ...
        foreach (System.Web.UI.WebControls.ListItem Item in ListBoxFuente.Items)
        {
            ...
            if (Item.Text != null)
            {
                ...
                DSRadicadoFuenteSQLTableAdapters.RadicadoFuente_ReadRadicadoFuenteTableAdapter TARadFuente = new DSRadicadoFuenteSQLTableAdapters.RadicadoFuente_ReadRadicadoFuenteTableAdapter();
                TARadFuente.Insert(GrpDocReg, Convert.ToInt64(RegistroCodigo), this.DropDownListGrupoFuente.SelectedValue, Convert.ToInt64(xcodigo));
            }
        }
    }
}