<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GestionTDocRecibido.aspx.cs" Inherits="AlfaNetConsultas_Gestion_GestionTDocRecibido" %>
...
<asp:Content ID="ContentGestionTDocRecibido" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
            ...
            <tr>
                <td style="text-align: center">
                    <asp:ObjectDataSource ID="ODSBuscar" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="GetGTRadicadov2" TypeName="RadicadoBLL" UpdateMethod="UpdateRadicado">
                        <SelectParameters>
                            ...
                            <cc1:AccordionPane ID="AccordionPane1" Font-Size="medium" runat="server" ContentCssClass="" HeaderCssClass="">
                                ...
                                <Content>
                                    <table style="WIDTH: 100%; TEXT-ALIGN: left" forecolor="White">
                                        <tbody>
                                            <tr>
                                                <td style="WIDTH: 100%; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">
                                                    Consulta Gestion de Tareas Recibida
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 8px" colspan="3">
                                                    Ver:
                                                    &nbsp;
                                                    <asp:DropDownList id="DDLSel" runat="server" Width="500px" CausesValidation="True" ValidationGroup="Buscar">
                                                    ...
                                                    &nbsp;
                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ValidationGroup="Buscar" 
                                                            ControlToValidate="DDLSel" ErrorMessage="Debe Seleccionar un tipo de Documento" 
                                                            InitialValue="Seleccione..." SetFocusOnError="True">
                                                    ...
                                                    <asp:UpdatePanel id="UpdatePanelFechas" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <cc1:CalendarExtender id="CalendarFinal" runat="server" TargetControlID="TxtFechaFinal" 
                                                                    Format="dd/MM/yyyy" PopupButtonID="ImgCalendarFinal">
                                                            </cc1:CalendarExtender>
                                                            <cc1:CalendarExtender id="CalendarInicial" runat="server" TargetControlID="TxtFechaInicial" 
                                                                    Format="dd/MM/yyyy" PopupButtonID="ImgCalendarInicial">
                                                            </cc1:CalendarExtender>
                                                            <asp:CheckBox id="ChBFechaRad" runat="server" Width="181px" Text="Entre Fechas de Radicacion" 
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label id="LblFechaInicial" runat="server" Width="63px" Text="Fecha Inicial" Visible="False">
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVFechaRadIni" runat="server" ValidationGroup="Buscar" 
                                                                                    ErrorMessage="*" ControlToValidate="TxtFechaInicial" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label id="LblFechaFinal" runat="server" Width="55px" Visible="False">
                                                                                FechaFinal
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVFecharadFin" runat="server" ValidationGroup="Buscar" 
                                                                                    ErrorMessage="*" ControlToValidate="TxtFechaFinal" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; BACKGROUND-COLOR: #ffffff">
                                                    <asp:UpdatePanel id="UPFechaFin" runat="server" UpdateMode="Conditional">
                                                        <contenttemplate>
                                                            <cc1:CalendarExtender id="CalendarFinFinal" runat="server" TargetControlID="TxtFechaFinFinal" 
                                                                    Format="dd/MM/yyyy" PopupButtonID="ImgCalendarFinFinal">
                                                            </cc1:CalendarExtender>
                                                            <cc1:CalendarExtender id="CalendarFinInicial" runat="server" TargetControlID="TxtFechaFinInicial" 
                                                                    Format="dd/MM/yyyy" PopupButtonID="ImgCalendarFinInicial">
                                                            </cc1:CalendarExtender>
                                                            <asp:CheckBox id="ChBFechaFin" runat="server" Width="181px" Text="Entre Fechas de Finalizacion" 
                                                                    OnCheckedChanged="ChBFechaFin_CheckedChanged" AutoPostBack="True">
                                                            </asp:CheckBox>
                                                            <br />
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label id="LblFechaFinInicial" runat="server" Width="63px" Text="Fecha Inicial" Visible="False">
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVFechaFinIni" runat="server" ValidationGroup="Buscar" 
                                                                                    ErrorMessage="*" ControlToValidate="TxtFechaFinInicial" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:TextBox id="TxtFechaFinInicial" runat="server" Width="70px" Font-Size="8pt" Visible="False">
                                                                            </asp:TextBox>
                                                                            <asp:Image id="ImgCalendarFinInicial" runat="server" Width="27px" Height="20px" 
                                                                                    ImageUrl="~/AlfaNetImagen/ToolBar/calendario.png" Visible="False">
                                                                            </asp:Image>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label id="LblFechaFinFinal" runat="server" Width="55px" Visible="False">
                                                                                FechaFinal
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVFechaFinFin" runat="server" ValidationGroup="Buscar" 
                                                                                    ErrorMessage="*" ControlToValidate="TxtFechaFinFinal" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:TextBox id="TxtFechaFinFinal" runat="server" Width="70px" Font-Size="8pt" Visible="False">
                                                                            </asp:TextBox>
                                                                            <asp:Image id="ImgCalendarFinFinal" runat="server" Width="27px" Height="20px" 
                                                                                    ImageUrl="~/AlfaNetImagen/ToolBar/calendario.png" Visible="False">
                                                                            </asp:Image>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; BACKGROUND-COLOR: #eff3fb">
                                                    <asp:UpdatePanel id="UPFechaVencimiento" runat="server" UpdateMode="Conditional">
                                                        <contenttemplate>
                                                            <cc1:CalendarExtender id="CalendarVenFinal" runat="server" TargetControlID="TxtFechaVenFinal" 
                                                                    PopupButtonID="ImgCalendarVenFinal" Format="dd/MM/yyyy">
                                                            </cc1:CalendarExtender>
                                                            <cc1:CalendarExtender id="CalendarVenInicial" runat="server" TargetControlID="TxtFechaVenInicial" 
                                                                    PopupButtonID="ImgCalendarVenInicial" Format="dd/MM/yyyy">
                                                            </cc1:CalendarExtender>
                                                            <asp:CheckBox id="ChBFechaVen" runat="server" Width="163px" Text="Entre Fechas de Vencimiento" 
                                                                    AutoPostBack="True" OnCheckedChanged="ChBFechaVen_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label id="LblFechaVenInicial" runat="server" Width="63px" Visible="False" Text="Fecha Inicial">
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVFechaVenIni" runat="server" ValidationGroup="Buscar" 
                                                                                    ControlToValidate="TxtFechaVenInicial" ErrorMessage="*" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:TextBox id="TxtFechaVenInicial" runat="server" Width="70px" Font-Size="8pt" Visible="False">
                                                                            </asp:TextBox>
                                                                            <asp:Image id="ImgCalendarVenInicial" runat="server" Width="27px" Visible="False" 
                                                                                    ImageUrl="~/AlfaNetImagen/ToolBar/calendario.png" Height="20px">
                                                                            </asp:Image>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label id="LblFechaVenFinal" runat="server" Width="55px" Visible="False">
                                                                                FechaFinal
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVFechaVenFin" runat="server" ValidationGroup="Buscar" 
                                                                                    ControlToValidate="TxtFechaVenFinal" ErrorMessage="*" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:TextBox id="TxtFechaVenFinal" runat="server" Width="70px" Font-Size="8pt" Visible="False">
                                                                            </asp:TextBox>
                                                                            <asp:Image id="ImgCalendarVenFinal" runat="server" Width="27px" Visible="False" 
                                                                                    ImageUrl="~/AlfaNetImagen/ToolBar/calendario.png" Height="20px">
                                                                            </asp:Image>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; BACKGROUND-COLOR: #ffffff">
                                                    <asp:UpdatePanel id="UpdatePanelDestino" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBDependencias" runat="server" Width="185px" Text="Entre Dependencias" 
                                                                    AutoPostBack="True" OnCheckedChanged="ChBDependencias_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <cc1:AutoCompleteExtender id="ACEDepDestino" runat="server" TargetControlID="TxtBDepDestino" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDependenciaByTextnull" 
                                                                    MinimumPrefixLength="1" CompletionSetCount="20">
                                                            </cc1:AutoCompleteExtender>
                                                            <cc1:PopupControlExtender id="PCDepDestino" runat="server" TargetControlID="TxtBDepDestino" 
                                                                    PopupControlID="PnlDepDestino" Position="Right">
                                                            </cc1:PopupControlExtender>
                                                            <cc1:PopupControlExtender id="PopupControlDepOrigen" runat="server" TargetControlID="TxtBDepOrigen" 
                                                                    PopupControlID="PnlDestino" Position="Right">
                                                            </cc1:PopupControlExtender> 
                                                            <cc1:AutoCompleteExtender id="AutoCompleteDepOrigen" runat="server" TargetControlID="TxtBDepOrigen" 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDependenciaByTextnull" 
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label id="LblDepOrigen" runat="server" Width="300px" Visible="False" 
                                                                                    Text="Dependencia Origen ...(Seleccione o ingrese criterio)">
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVDepOrigen" runat="server" ValidationGroup="Buscar" 
                                                                                    ControlToValidate="TxtBDepOrigen" ErrorMessage="*" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:TextBox id="TxtBDepOrigen" runat="server" Font-Size="8pt" Visible="False" 
                                                                                    CssClass="TxtAutoComplete">
                                                                            </asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label id="LblDepDestino" runat="server" Width="300px" Visible="False" 
                                                                                    Text="Dependencia Destino ...(Seleccione o ingrese criterio)">
                                                                            </asp:Label>
                                                                            <asp:RequiredFieldValidator id="RFVDepDestino" runat="server" ValidationGroup="Buscar" 
                                                                                    ControlToValidate="TxtBDepDestino" ErrorMessage="*" Enabled="False">
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:TextBox id="TxtBDepDestino" runat="server" Font-Size="8pt" Visible="False" CssClass="TxtAutoComplete">
                                                                            </asp:TextBox>
                                                                            &nbsp;&nbsp; 
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <asp:Panel style="LEFT: 302px" id="PnlDepDestino" runat="server" Height="300px" CssClass="popupControl" 
                                                                    ScrollBars="Vertical">
                                                                <div>
                                                                    <asp:TreeView id="TVDepDestino" runat="server" Width="300px" ShowLines="True" 
                                                                            OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate" 
                                                                            OnSelectedNodeChanged="TVDepDestino_SelectedNodeChanged" ExpandDepth="0">
                                                                        <ParentNodeStyle Font-Bold="False"></ParentNodeStyle>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #eff3fb" colspan="3">
                                                    <asp:UpdatePanel id="UPFuente" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBFuente" runat="server" Width="185px" Text="Resueltos o Por Resolver" AutoPostBack="True" 
                                                                    OnCheckedChanged="ChBFuente_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            &nbsp;
                                                            <asp:Label id="LblFuente" runat="server" Width="85px" Visible="False" Text="Radicado Fuente">
                                                            </asp:Label>
                                                            <asp:RequiredFieldValidator id="RFVFuente" runat="server" ValidationGroup="Buscar" 
                                                                    ControlToValidate="TxtBFuente" ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator>
                                                            <asp:RadioButtonList id="RadioButtonList1" runat="server" Width="180px" Visible="False" 
                                                                    RepeatDirection="Horizontal">
                                                                <asp:ListItem Value="1">Resueltos</asp:ListItem>
                                                                <asp:ListItem Value="0">Por Resolver</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                            <cc1:AutoCompleteExtender id="AutoCompleteFuente" runat="server" TargetControlID="TxtBFuente" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetRadicadoByCodigo" MinimumPrefixLength="1">
                                                            </cc1:AutoCompleteExtender>
                                                            <asp:TextBox id="TxtBFuente" runat="server" Width="400px" Font-Size="8pt" Visible="False" CssClass="TxtAutoComplete">
                                                            </asp:TextBox>
                                                            &nbsp; 
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #ffffff" colspan="3">
                                                    <asp:UpdatePanel id="UPProceso" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBProceso" runat="server" Width="185px" Text="Por Proceso" AutoPostBack="True" 
                                                                    OnCheckedChanged="ChBProceso_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            <asp:Label id="LblProceso" runat="server" Width="85px" Visible="False" Text="Proceso">
                                                            </asp:Label>
                                                            <asp:RequiredFieldValidator id="RFVProceso" runat="server" ValidationGroup="Buscar" 
                                                                    ControlToValidate="TxtBProceso" ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator>
                                                            <cc1:AutoCompleteExtender id="AutoCompleteProceso" runat="server" TargetControlID="TxtBProceso" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetWFProcesoTextByText " 
                                                                    MinimumPrefixLength="1" CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                            </cc1:AutoCompleteExtender>
                                                            <cc1:PopupControlExtender id="PopupControlProceso" runat="server" TargetControlID="TxtBProceso" 
                                                                    PopupControlID="Panel88" Position="Right">
                                                            </cc1:PopupControlExtender>
                                                            <asp:Panel id="Panel88" runat="server" Width="300px" Height="300px" CssClass="popupControl" 
                                                                    ScrollBars="Vertical">
                                                                <div>
                                                                    <asp:TreeView id="TreeVProceso" runat="server" Width="300px" ShowLines="True" 
                                                                            OnTreeNodePopulate="TreeVProceso_TreeNodePopulate" 
                                                                            OnSelectedNodeChanged="TreeVProceso_SelectedNodeChanged" ExpandDepth="0">
                                                                        <ParentNodeStyle Font-Bold="False"></ParentNodeStyle>
                                                            ...
                                                            <asp:TextBox id="TxtBProceso" runat="server" Width="400px" Font-Size="8pt" Visible="False" CssClass="TxtAutoComplete">
                                                            </asp:TextBox> 
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #eff3fb" colspan="3">
                                                    <asp:UpdatePanel id="UPAccion" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBAccion" runat="server" Width="185px" Text="Por Accion" AutoPostBack="True" 
                                                                    OnCheckedChanged="ChBAccion_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            <asp:Label id="LblAccion" runat="server" Width="85px" Visible="False" Text="Accion">
                                                            </asp:Label>
                                                            <asp:RequiredFieldValidator id="RFVAccion" runat="server" ValidationGroup="Buscar" ControlToValidate="TxtBAccion" 
                                                                    ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator>
                                                            <cc1:AutoCompleteExtender id="AutoCompleteAccion" runat="server" TargetControlID="TxtBAccion" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetWFAccionTextByText" MinimumPrefixLength="1" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                            </cc1:AutoCompleteExtender>
                                                            <cc1:PopupControlExtender id="PopupControlAccion" runat="server" TargetControlID="TxtBAccion" PopupControlID="PnlAccion" 
                                                                    Position="Right">
                                                            </cc1:PopupControlExtender>
                                                            <asp:Panel id="PnlAccion" runat="server" Width="300px" Height="300px" CssClass="popupControl" ScrollBars="Vertical">
                                                                <div>
                                                                    <asp:TreeView id="TreeVAccion" runat="server" Width="300px" ShowLines="True" 
                                                                        ...
                                                                        <Nodes>
                                                                            <asp:TreeNode Expanded="False" PopulateOnDemand="True" SelectAction="Expand" Text="Seleccione Accion..." 
                                                                                    Value="0">
                                                                            </asp:TreeNode>
                                                                        </Nodes>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #ffffff" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelNaturaleza" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBNaturaleza" runat="server" Width="185px" Text="Por Naturaleza" AutoPostBack="True" 
                                                            ...
                                                            <asp:RequiredFieldValidator id="RFVNaturaleza" runat="server" ValidationGroup="Buscar" 
                                                                    ControlToValidate="TxtBNaturaleza" ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator>
                                                            <cc1:AutoCompleteExtender id="AutoCompleteNaturaleza" runat="server" TargetControlID="TxtBNaturaleza" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetNaturalezaByText" MinimumPrefixLength="1" 
                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                            </cc1:AutoCompleteExtender>
                                                            <cc1:PopupControlExtender id="PopupControlNaturaleza" runat="server" TargetControlID="TxtBNaturaleza" 
                                                                    PopupControlID="PnlNaturaleza" Position="Right">
                                                            </cc1:PopupControlExtender>
                                                            <asp:TextBox id="TxtBNaturaleza" runat="server" Width="400px" Font-Size="8pt" Visible="False" 
                                                                    CssClass="TxtAutoComplete">
                                                            </asp:TextBox>
                                                            <asp:Panel id="PnlNaturaleza" runat="server" Height="300px" CssClass="popupControl" 
                                                                    ScrollBars="Vertical">
                                                                <div>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #eff3fb" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelExpediente" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBExpediente" runat="server" Width="185px" Text="Por Expediente" AutoPostBack="True" 
                                                                    OnCheckedChanged="ChBExpediente_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            <asp:Label id="LblExpediente" runat="server" Width="60px" Visible="False" Text="Expediente">
                                                            </asp:Label>
                                                            <asp:RequiredFieldValidator id="RFVExpediente" runat="server" ValidationGroup="Buscar" 
                                                                    ControlToValidate="TxtBExpediente" ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator> 
                                                            ...
                                                            <cc1:PopupControlExtender id="PopupControlExpediente" runat="server" TargetControlID="TxtBExpediente" 
                                                                    PopupControlID="PnlExpediente" Position="Right">
                                                            </cc1:PopupControlExtender>
                                                            <asp:TextBox id="TxtBExpediente" runat="server" Width="400px" Font-Size="8pt" Visible="False" CssClass="TxtAutoComplete">
                                                            </asp:TextBox>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #ffffff" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelProcedencia" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:CheckBox id="ChBProcedencia" runat="server" Width="185px" Text="Por Procedencia" AutoPostBack="True" 
                                                                    OnCheckedChanged="ChBProcedencia_CheckedChanged">
                                                            </asp:CheckBox>
                                                            <br />
                                                            <asp:Label id="LblProcedencia" runat="server" Width="300px" Visible="False" 
                                                                    Text="Procedencia ...(Seleccione o ingrese Criterio)">
                                                            </asp:Label>
                                                            <asp:RequiredFieldValidator id="RFVProcedencia" runat="server" ValidationGroup="Buscar" 
                                                                    ControlToValidate="TxtBProcedencia" ErrorMessage="*" Enabled="False">
                                                            </asp:RequiredFieldValidator>
                                                            <cc1:AutoCompleteExtender id="ACEProcedencia" runat="server" TargetControlID="TxtBProcedencia" 
                                                                    ServicePath="../../AutoComplete.asmx" ServiceMethod="GetProcedenciaByTextNombre" 
                                                                    MinimumPrefixLength="1" CompletionListCssClass="autocomplete_completionListElement" 
                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                            </cc1:AutoCompleteExtender>
                                                            <asp:TextBox id="TxtBProcedencia" runat="server" Width="400px" Font-Size="8pt" Visible="False" CssClass="TxtAutoComplete">
                                                            </asp:TextBox> 
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ChBProcedencia" EventName="CheckedChanged"></asp:AsyncPostBackTrigger>
                                            ...
                                            <tr>
                                                <td style="WIDTH: 100%; COLOR: white; BACKGROUND-COLOR: #507cd1" colspan="3">
                                                    <asp:Table id="Table3" runat="server" Width="125px" ForeColor="White" Height="30px" CellPadding="0" CellSpacing="4">
                                                        <asp:TableRow ID="TableRow1" runat="server">
                                                            <asp:TableCell ID="clBuscar" runat="server" CssClass="BarButton">
                                                                <asp:LinkButton ID="cmdBuscar" ForeColor="White" runat="server" BorderStyle="None"
                                                                        CssClass="CommandButton" OnClick="cmdBuscar_Click" TabIndex="24" Text="Buscar" ValidationGroup="Buscar">
                                                                </asp:LinkButton>
                                                            </asp:TableCell>
                                                    ...
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    <asp:ImageButton id="ImgBtnBuscar" onclick="cmdBuscar_Click" runat="server" Width="18px" Visible="False" 
                                                            ImageUrl="~/AlfaNetImagen/ToolBar/tbBuscar.gif" Height="17px" ValidationGroup="Buscar">
                                                    </asp:ImageButton>
                                                </td>
                                            </tr>
                                        </tbody>
                                                        ...
                                                        <ContentCollection>
                                                            <dxpc:PopupControlContentControl runat="server">
                                                                <dxcp:ASPxCallbackPanel runat="server" ClientInstanceName="callbackPanel" RenderMode="Table" 
                                                                    ...
                                                                    <LoadingPanelImage Url="~/App_Themes/Office2003 Blue/Web/Loading.gif">
                                                                    </LoadingPanelImage>
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="Respuesta" Caption="Rpta" VisibleIndex="6">
                                                                        ...
                                                                        <DataItemTemplate>
                                                                            Rpta:
                                                                            <br />
                                                                            <asp:Label id="Label6" runat="server" Visible="False" Text='<%# Bind("Respuesta") %>'>
                                                                            </asp:Label>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="WFAccionNombre" Caption="Accion" VisibleIndex="7">
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn FieldName="ExpedienteNombre" Caption="Expediente" VisibleIndex="8">
                                                                        <Settings AutoFilterCondition="Contains"></Settings>
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn FieldName="SerieNombre" Caption="Serie" VisibleIndex="9">
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="Opciones" UnboundType="String" Caption="Opciones" VisibleIndex="11">
                                                                        ...
                                                                        <DataItemTemplate>
                                                                            ...
                                                                            <br />
                                                                            <asp:HyperLink id="HprLnkHisExtven" runat="server" Width="55px" Font-Underline="True" 
                                                                                    CssClass="LinKBtnStyleBig">
                                                                                Histórico
                                                                            </asp:HyperLink>
                                                                            <br />
                                                                            <asp:HyperLink id="HprLnkExp" runat="server" Text="Expediente" 
                                                                                    CssClass="LinKBtnStyleBig" Target="_blank">
                                                                            </asp:HyperLink>
            ...
            <tr>
                <td>
                    ...
                    <asp:ValidationSummary Style="vertical-align: middle; text-align: left" ID="ValidationSummaryRadicado"
                            runat="server" Width="100%" Height="1px" Font-Size="10pt" DisplayMode="List">
