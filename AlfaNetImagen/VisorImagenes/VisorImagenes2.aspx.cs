...
public partial class VImagenes2 : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                if (TipoArchivo == "gif" || TipoArchivo == "Gif" || TipoArchivo == "GIF" || TipoArchivo == "jpg" || TipoArchivo == "JPG" || TipoArchivo == "Jpg" || TipoArchivo == "png" || TipoArchivo == "PNG" || TipoArchivo == "Png" || TipoArchivo == "BMP" || TipoArchivo == "Bmp" || TipoArchivo == "bmp" || TipoArchivo == "TIF" || TipoArchivo == "Tif" || TipoArchivo == "tif")
                {
                    ...
                    {
                        if (!File.Exists(HFPath.Value + HFFileName.Value))
                        {
                            this.LblMessageBox.Text = "Error: El archivo " + HFPath.Value + HFFileName.Value + " no existe";
                        ...
                        {
                            //Carga la imagen
                            FileInfo f = new FileInfo(HFPath.Value + HFFileName.Value);
                            long s1 = f.Length;
                            this.LblMessageBox.Text = "El archivo " + HFPath.Value + HFFileName.Value + "  existe ";
                            
                            this.LblMessageBox.Text += " Tamaño: " + f.Length;
                            this.MPEMensaje.Show();
                            /*
                            System.Drawing.Image img1 = System.Drawing.Image.FromFile(HFPath.Value + HFFileName.Value);

                            MemoryStream ms = new MemoryStream();

                            img1.Save(ms, System.Drawing.Imaging.ImageFormat.Tiff);
                            ...
                            imgElem.SourceBase64 = base64String;*/
                    ...
                    else
                    {
                        if (!File.Exists(HFPath.Value + HFFileName.Value))
                        {
                            this.LblMessageBox.Text = "El archivo " + HFPath.Value + HFFileName.Value + " no existe pero detectó que tiene varias paginas";
                        ...
                        else
                        {
                            ...
                            this.LblMessageBox.Text = " El archivo " + HFPath.Value + HFFileName.Value + "  existe y detectó que tiene varias paginas";
                            this.LblMessageBox.Text += " Tamaño: " + f.Length;
                            this.MPEMensaje.Show();
                            System.Drawing.Image img1 = System.Drawing.Image.FromFile(HFPath.Value + HFFileName.Value);
...
/////////////////////////////////////////////////////////////////
                    ...
                    for (int i = 0; i < t; i++)
                    {
                        ddlPages.Items.Add(new System.Web.UI.WebControls.ListItem("Page " + (i + 1).ToString(), i.ToString()));
                    }
            ...
            if (this.FileUpload1.HasFile)
            {
                ...
                if (Convert.ToInt32(Request["GrupoPadreCodigo"]) == 1)
                {
                    ...
                    if (CodigoRuta == null)
                    {
                        ...
                        {
                            TARadicadoImagen.InsertRadicadoImagen(GGrupo, Convert.ToInt32(this.HFNroDoc.Value), this.FileUpload1.FileName, codigoR);
                ...
                else if (Convert.ToInt32(Request["GrupoPadreCodigo"]) == 2)
                {
                    ...
                    if (CodigoRuta == null)
                    {
                        ...
                        if (Directory.Exists(PathVirtual))
                        {
                            TARegistroImagen.InsertRegistroImagen(GGrupo, Convert.ToInt32(this.HFNroDoc.Value), this.FileUpload1.FileName, codigoR);
                            this.FileUpload1.SaveAs(PathVirtual + this.FileUpload1.FileName);
                        }
                        else
                        {
