<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisorImagenes2.aspx.cs" Inherits="VImagenes2" %>
...
<contenttemplate>
<TABLE style="WIDTH: 607px"><TBODY><TR><TD style="WIDTH: 32647px"><asp:Label id="LblDocumentoNro" runat="server" Width="110px" Font-Size="Small" ForeColor="Red" Text="Label" Font-Bold="True">
</asp:Label> </TD><TD><IMG src="../../AlfaNetImagen/ToolBar/file.gif" /> </TD><TD style="WIDTH: 339px"><asp:FileUpload id="FileUpload1" runat="server" Width="420px">
...
<asp:PostBackTrigger ControlID="BtnEnviar"></asp:PostBackTrigger>
    ...
    <table border="0">
    <tbody><tr><td style="width: 26px;" valign="baseline"><asp:ImageButton id="prevButton" onclick="prevButton_Click" runat="server" ImageUrl="~/AlfaNetImagen/ToolBar/prev.gif" CssClass="PointerCursor" AlternateText="Pagina Anterior..."></asp:ImageButton></TD><TD vAlign=baseline><asp:DropDownList id="ddlPages" runat="server" onselectedindexchanged="ddlPages_SelectedIndexChanged" AutoPostBack="True" CssClass="PointerCursor">
                    </asp:DropDownList></td><td valign=baseline><asp:ImageButton id="nextButton" onclick="nextButton_Click" runat="server" ImageUrl="~/AlfaNetImagen/ToolBar/next.gif" CssClass="PointerCursor" AlternateText="Pagina Siguiente..."></asp:ImageButton></TD>
        <td align="left" style="width: 3px;" valign="middle">
            <asp:ImageButton ID="zoomMasButton" runat="server" AlternateText="Zoom In..." CssClass="PointerCursor" onclick="zoomMasButton_Click"
                ImageUrl="~/AlfaNetImagen/ToolBar/zoommas.gif"/></td>
        <td align="left" style="width: 3px;" valign="middle">
            <asp:ImageButton ID="zoomMenosButton" runat="server" AlternateText="Zoom Out..." CssClass="PointerCursor" onclick="zoomMenosButton_Click"
                ImageUrl="~/AlfaNetImagen/ToolBar/zoommenos.gif" /></td>
        <td valign="middle" align="left">
        <asp:ImageButton id="rotarIzqButton" onclick="rotarIzqButton_Click" runat="server" ImageUrl="~/AlfaNetImagen/ToolBar/rotarizq.gif" CssClass="PointerCursor" AlternateText="Rotar a la izquierda...">
        </asp:ImageButton>
        <asp:ImageButton id="rotarDerButton" onclick="rotarDerButton_Click" runat="server" ImageUrl="~/AlfaNetImagen/ToolBar/rotarder.gif" CssClass="PointerCursor" AlternateText="Rotar a la derecha..." ToolTip="Rotar Derecha Imagen"></asp:ImageButton>
        </TD><TD vAlign=middle align=left></TD><TD style="WIDTH: 57px;" vAlign=middle align=left><asp:DropDownList id="ddlZoom" runat="server" onselectedindexchanged="ddlZoom_SelectedIndexChanged" AutoPostBack="True" CssClass="PointerCursor">
        ...
        <td align="left" valign="middle" style="width: 90px">
            <asp:Panel ID="PnlPrint" runat="server">
                <asp:ImageButton ID="ImgBtnPrintPDF" runat="server" Height="21px" ImageUrl="~/AlfaNetImagen/ToolBar/icono_pdf.gif"
                    Width="20px" OnClick="ImgBtnPrintPDF_Click" />
            <asp:Image ID="ImgPrint" runat="server" ImageUrl="~/AlfaNetImagen/ToolBar/action_print.gif" Width="16px" />
                </asp:Panel>
        </td>
...
<div id ="currentPage" class="viewerContainer">
    <neoimg:ImageDraw ID="ImageDraw2" runat="server" CacheExpiresAtDateTime=""
        ...
        <Canvas CenterElements="True" Fill-BackgroundColor="115, 111, 110" Fill-ForegroundColor="0, 0, 0" Fill-GradientColor1="255, 255, 255" Fill-GradientColor2="0, 0, 0" Height="700" Width="700" />
        <Elements>
            <neoimg:ImageElement Height="700" MultiPageIndex="0" Name="myTiff" NullImageUrl="~/AlfaNetImagen/iconos/icono_Blanco.JPG"
                Source="File" SourceFile="E:\AlfaNet\AlfaNetApp\AlfaNetRepositorioImagenes\Radicados\2011\3\IMGRAD153303_02032011_1.TIF"
                UseSourceDpi="False" Width="700">
            </neoimg:ImageElement>
        </Elements>
