...
public partial class _MaestroUsuario : System.Web.UI.Page
{
    ...
    protected void ImgBtnAcceptInsert_Click(object sender, ImageClickEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            this.LblMessageBox.Text = "1. Ocurrio un problema al tratar de adicionar el registro. ";
    ...
    protected void ImgBtnAcceptEdit_Click(object sender, ImageClickEventArgs e)
    {
         try
        {
            ...
            DSUsuarioTableAdapters.UsuariosxdependenciaTableAdapter ObjTaUsuario = new DSUsuarioTableAdapters.UsuariosxdependenciaTableAdapter();
            ObjTaUsuario.UsuariosByUpdateUsuarios(memberuser.ProviderUserKey.ToString(), TxtDependencia.Text.Remove(TxtDependencia.Text.IndexOf(" | ")).ToString().Trim(), this.TxtNombre.Text, this.TxtApellido.Text);
    ...
    {
        //Display a user-friendly message
        this.LblMessageBox.Text = "2. Ocurrio un problema al tratar de editar el registro. ";
        Exception inner = ex.InnerException;
        this.LblMessageBox.Text += ErrorHandled.FindError(inner);
        this.LblMessageBox.Text += ex.Message.ToString();
        this.MPEMensaje.Show();
    ...
    protected void ImgBtnFind_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (RadBtnLstFindby.SelectedValue == "3")
            {
                ...
                {
                    this.LblMessageBox.Text = "3. El Usuario No Existe o Fue Modificado";
                    this.MPEMensaje.Show();
                    return;
                }
            }
            else if (RadBtnLstFindby.SelectedValue == "1")
            {
                ...
                if (TxtUsuario.Text != null)
                {
                    if (TxtUsuario.Text.Contains(" | "))
                    {
                        ...
                        {
                            this.LblMessageBox.Text = "1. El Usuario No Existe o Fue Modificado";
                            this.MPEMensaje.Show();
                            return;
                        }
            ...
            else if (RadBtnLstFindby.SelectedValue == "2")
            {
                ...
                if (TxtUsuario.Text != null)
                {
                    if (TxtUsuario.Text.Contains(" | "))
                    {
                        ...
                        {
                            this.LblMessageBox.Text = "2. El Usuario No Existe o Fue Modificado";
                            this.MPEMensaje.Show();
                            return;
                        }
                  }
        ...
        {
            //Display a user-friendly message
            this.LblMessageBox.Text = "3. Ocurrio un problema al tratar de Buscar el registro. ";
            Exception inner = ex.InnerException;
            this.LblMessageBox.Text += ErrorHandled.FindError(inner);
            //this.LblMessageBox.Text += ex.Message.ToString();
            this.MPEMensaje.Show();
