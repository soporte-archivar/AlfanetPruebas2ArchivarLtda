<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="MaestroForma.aspx.cs" Inherits="AlfaNetAdministracion_AdminMaestros_MaestroForma" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <tr>
                ...
                <td style="WIDTH: 40%;">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            <ajax:autocompleteextender id="AutoCompleteDepartamento" runat="server" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem" CompletionListCssClass="autocomplete_completionListElement" targetcontrolid="TxtForma" servicepath="../../AutoComplete.asmx" servicemethod="GetFormaTextByTextnull" minimumprefixlength="0" enablecaching="true" completionsetcount="12" completioninterval="1000">
                            </ajax:autocompleteextender>
                            <Ajax:TextBoxWatermarkExtender id="TxtBoxWatermarkDepartamento" watermarkText="Seleccione una Forma ..." runat="server" TargetControlID="TxtForma">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 84%">
                                        <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ControlToValidate="TxtForma" ErrorMessage="RequiredFieldValidator" SetFocusOnError="True" ValidationGroup="ValGroup1">*</asp:RequiredFieldValidator>
                                        <asp:label id="LblForma" runat="server" Width="60px" Text="Forma" Font-Bold="False" CssClass="PropLabels">
                                        </asp:label>
                                        <asp:TextBox id="TxtForma" runat="server" CssClass="TxtAutoComplete">
                                        </asp:TextBox>
                            ...
                            <Ajax:TabContainer style="TEXT-ALIGN: left" id="TCForma" runat="server" Width="500px" BackColor="White" AutoPostBack="True" ActiveTabIndex="0" OnActiveTabChanged="TCGrupo_ActiveTabChanged">
                                <Ajax:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                    ...
                                    <ContentTemplate>
                                    <div>
                                        <asp:DetailsView style="VERTICAL-ALIGN: middle; TEXT-ALIGN: left" id="DVForma" runat="server" Width="460px" DataSourceID="GrupoByIdDataSource" ForeColor="#333333" Height="31px" OnItemUpdated="DVDepartamento_ItemUpdated" OnItemInserted="DVDepartamento_ItemInserted" OnItemDeleted="DVDepartamento_ItemDeleted" OnDataBound="DVDepartamento_DataBound" GridLines="None" DataKeyNames="FormaCodigo" CellPadding="4" AutoGenerateRows="False" EnableModelValidation="True">
                                            <AlternatingRowStyle BackColor="White"/>
                                            <CommandRowStyle BackColor="#D1DDF1" Font-Bold="True"/>
                                            <EditRowStyle BackColor="#2461BF"/>
                                            <FieldHeaderStyle BackColor="#DEE8F5" Font-Bold="True"/>
                                            <Fields>
                                                <asp:TemplateField HeaderText="Codigo Forma" SortExpression="FormaCodigo">
                                                    <EditItemTemplate>
                                                        <asp:Label id="Label1" runat="server" Text='<%# Eval("FormaCodigo") %>'>
                                                        </asp:Label>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("FormaCodigo") %>'>
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Debe ingresar un codigo para la Forma">*</asp:RequiredFieldValidator>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label id="Label1" runat="server" Text='<%# Bind("FormaCodigo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Nombre Forma" SortExpression="FormaNombre">
                                                    <EditItemTemplate>
                                                        <asp:Label id="Label3" runat="server" Text='<%# Eval("FormaNombre") %>'>
                                                        </asp:Label>
                                                        <asp:Label id="Label13" runat="server" ForeColor="White" Text="Forma Asociada">
                                                        </asp:Label>
                                                        <asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("FormaNombre") %>' CssClass="TxtMaestro">
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox1" ErrorMessage="Debe ingresar un nombre para la Forma">*</asp:RequiredFieldValidator>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>                                                
                                                        <asp:TextBox id="TextBox3" runat="server" Text='<%# Bind("FormaNombre") %>' CssClass="TxtMaestro">
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="Debe ingresar un nombre para la Forma">*</asp:RequiredFieldValidator>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label id="Label3" runat="server" Text='<%# Bind("FormaNombre") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Habilitar/DesHabilitar" SortExpression="FormaHabilitar">
                                                    <EditItemTemplate>
                                                        <asp:TextBox id="TextBox2" runat="server" Width="13px" Text='<%# Bind("FormaHabilitar") %>' Visible="False">
                                                        </asp:TextBox>
                                                        <asp:CheckBox id="CheckBox1" runat="server">
                                                        </asp:CheckBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox id="TextBox2" runat="server" Width="11px" Text='<%# Bind("FormaHabilitar") %>' Visible="False">
                                                        </asp:TextBox>
                                                        <asp:CheckBox id="CheckBox1" runat="server">
                                                        </asp:CheckBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label id="Label2" runat="server" Text='<%# Bind("FormaHabilitar") %>' Visible="False">
                                                        </asp:Label>
                            ...
                            <Ajax:ModalPopupExtender id="MPEMensaje" runat="server" TargetControlID="LblForma" BackgroundCssClass="MessageStyle" PopupControlID="PnlMensaje">
    ...
    <asp:ObjectDataSource ID="GrupoByIdDataSource" runat="server" DeleteMethod="Delete"
            InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetFormaBy"
            TypeName="DSFormaTableAdapters.Forma_ReadFormaTableAdapter" UpdateMethod="Update">
            <SelectParameters>
                <asp:ControlParameter ControlID="HFCodigoSeleccionado" Name="FormaCodigo" PropertyName="Value"
                    Type="String" />
            </SelectParameters>
            <DeleteParameters>
                <asp:Parameter Name="Original_FormaCodigo" Type="String" />
            </DeleteParameters>
            <UpdateParameters>
                <asp:Parameter Name="FormaNombre" Type="String" />
                <asp:Parameter Name="FormaHabilitar" Type="String" />
                <asp:Parameter Name="Original_FormaCodigo" Type="String" />
            </UpdateParameters>
            <InsertParameters>
                <asp:Parameter Name="FormaCodigo" Type="String" />
                <asp:Parameter Name="FormaNombre" Type="String" />
                <asp:Parameter Name="FormaHabilitar" Type="String" />
            </InsertParameters>
        </asp:ObjectDataSource>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStrSQLServer %>"
        SelectCommand="SELECT MAX(CONVERT (bigint, dbo.UDF_ParseAlphaChars(FormaCodigo)) + 1) AS Consecutivo FROM Forma_de_conservacion">
    </asp:SqlDataSource>
</asp:Content>  