<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="MaestroUbicacion.aspx.cs" Inherits="AlfaNetAdministracion_AdminMaestros_MaestroUbicacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <tr>
                ...
                <td style="WIDTH: 40%;">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            <ajax:autocompleteextender id="AutoCompleteDepartamento" runat="server" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem" CompletionListCssClass="autocomplete_completionListElement" targetcontrolid="TxtUbicacion" servicepath="../../AutoComplete.asmx" servicemethod="GetUbicacionTextByTextnull" minimumprefixlength="0" enablecaching="true" completionsetcount="12" completioninterval="1000">
                            </ajax:autocompleteextender>
                            <Ajax:TextBoxWatermarkExtender id="TxtBoxWatermarkDepartamento" watermarkText="Seleccione una Ubicacion ..." runat="server" TargetControlID="TxtUbicacion">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 84%">
                                        <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ControlToValidate="TxtUbicacion" ErrorMessage="RequiredFieldValidator" SetFocusOnError="True" ValidationGroup="ValGroup1">*</asp:RequiredFieldValidator>
                                        <asp:label id="LblUbicacion" runat="server" Width="60px" Text="Ubicacion" Font-Bold="False" CssClass="PropLabels">
                                        </asp:label>
                                        <asp:TextBox id="TxtUbicacion" runat="server" CssClass="TxtAutoComplete">
                                        </asp:TextBox>
                            ...
                            <Ajax:TabContainer style="TEXT-ALIGN: left" id="TCUbicacion" runat="server" Width="500px" BackColor="White" AutoPostBack="True" ActiveTabIndex="0" OnActiveTabChanged="TCGrupo_ActiveTabChanged">
                                <Ajax:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                                    ...
                                    <ContentTemplate>
                                    <div>
                                        <asp:DetailsView style="VERTICAL-ALIGN: middle; TEXT-ALIGN: left" id="DVUbicacion" runat="server" Width="460px" DataSourceID="GrupoByIdDataSource" ForeColor="#333333" Height="31px" OnItemUpdated="DVDepartamento_ItemUpdated" OnItemInserted="DVDepartamento_ItemInserted" OnItemDeleted="DVDepartamento_ItemDeleted" OnDataBound="DVDepartamento_DataBound" GridLines="None" DataKeyNames="UbicacionCodigo" CellPadding="4" AutoGenerateRows="False" EnableModelValidation="True">
                                            <AlternatingRowStyle BackColor="White"/>
                                            <CommandRowStyle BackColor="#D1DDF1" Font-Bold="True"/>
                                            <EditRowStyle BackColor="#2461BF"/>
                                            <FieldHeaderStyle BackColor="#DEE8F5" Font-Bold="True"/>
                                            <Fields>
                                                <asp:TemplateField HeaderText="Codigo Ubicacion" SortExpression="UbicacionCodigo">
                                                    <EditItemTemplate>
                                                        <asp:Label id="Label1" runat="server" Text='<%# Eval("UbicacionCodigo") %>'>
                                                        </asp:Label>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("UbicacionCodigo") %>'>
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Debe ingresar un codigo para la Ubicacion">*</asp:RequiredFieldValidator>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label id="Label1" runat="server" Text='<%# Bind("UbicacionCodigo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Nombre Ubicacion" SortExpression="UbicacionNombre">
                                                    <EditItemTemplate>
                                                        <asp:Label id="Label3" runat="server" Text='<%# Eval("UbicacionNombre") %>'>
                                                        </asp:Label>
                                                        <asp:Label id="Label13" runat="server" ForeColor="White" Text="Ubicacion Asociada">
                                                        </asp:Label>
                                                        <asp:TextBox id="TextBox1" runat="server" Text='<%# Bind("UbicacionNombre") %>' CssClass="TxtMaestro">
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox1" ErrorMessage="Debe ingresar un nombre para la Ubicacion">*</asp:RequiredFieldValidator>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>                                                
                                                        <asp:TextBox id="TextBox3" runat="server" Text='<%# Bind("UbicacionNombre") %>' CssClass="TxtMaestro">
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="Debe ingresar un nombre para la Ubicacion">*</asp:RequiredFieldValidator>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label id="Label3" runat="server" Text='<%# Bind("UbicacionNombre") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Habilitar/DesHabilitar" SortExpression="UbicacionHabilitar">
                                                    <EditItemTemplate>
                                                        <asp:TextBox id="TextBox2" runat="server" Width="13px" Text='<%# Bind("UbicacionHabilitar") %>' Visible="False">
                                                        </asp:TextBox>
                                                        <asp:CheckBox id="CheckBox1" runat="server">
                                                        </asp:CheckBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox id="TextBox2" runat="server" Width="11px" Text='<%# Bind("UbicacionHabilitar") %>' Visible="False">
                                                        </asp:TextBox>
                                                        <asp:CheckBox id="CheckBox1" runat="server">
                                                        </asp:CheckBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label id="Label2" runat="server" Text='<%# Bind("UbicacionHabilitar") %>' Visible="False">
                                                        </asp:Label>
                            ...
                            <Ajax:ModalPopupExtender id="MPEMensaje" runat="server" TargetControlID="LblUbicacion" BackgroundCssClass="MessageStyle" PopupControlID="PnlMensaje">
    ...
    <asp:ObjectDataSource ID="GrupoByIdDataSource" runat="server" DeleteMethod="Delete"
            InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetUbicacionBy"
            TypeName="DSUbicacionTableAdapters.Ubicacion_ReadUbicacionTableAdapter" UpdateMethod="Update">
            <SelectParameters>
                <asp:ControlParameter ControlID="HFCodigoSeleccionado" Name="UbicacionCodigo" PropertyName="Value"
                    Type="String" />
            </SelectParameters>
            <DeleteParameters>
                <asp:Parameter Name="Original_UbicacionCodigo" Type="String" />
            </DeleteParameters>
            <UpdateParameters>
                <asp:Parameter Name="UbicacionNombre" Type="String" />
                <asp:Parameter Name="UbicacionHabilitar" Type="String" />
                <asp:Parameter Name="Original_UbicacionCodigo" Type="String" />
            </UpdateParameters>
            <InsertParameters>
                <asp:Parameter Name="UbicacionCodigo" Type="String" />
                <asp:Parameter Name="UbicacionNombre" Type="String" />
                <asp:Parameter Name="UbicacionHabilitar" Type="String" />
            </InsertParameters>
        </asp:ObjectDataSource>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStrSQLServer %>"
        SelectCommand="SELECT MAX(CONVERT (bigint, dbo.UDF_ParseAlphaChars(UbicacionCodigo)) + 1) AS Consecutivo FROM UbicacionGeografica">
    </asp:SqlDataSource>
</asp:Content>  
