...
public partial class _MaestroWorkFlowAccion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.TCGrupo.Tabs[1].Visible = false;
    ...
    protected void DVDepartamento_DataBound(Object sender, EventArgs e)
    {
        ...
        {
            Label LblCodProce = (Label)DVGrupo.FindControl("Label1");
            
            DSAccionTableAdapters.WFAccion_ReadExisteWFAccionTableAdapter TAWFAccionExiste = new DSAccionTableAdapters.WFAccion_ReadExisteWFAccionTableAdapter();
            DSAccion.WFAccion_ReadExisteWFAccionDataTable DTWFAccionExiste = new DSAccion.WFAccion_ReadExisteWFAccionDataTable();
            DTWFAccionExiste = TAWFAccionExiste.GetWFAccion_ReadExisteWFAccion(LblCodProce.Text);

            Label LblProce = (Label)DVGrupo.FindControl("Label3");
            TextBox TxtProce = (TextBox)DVGrupo.FindControl("TextBox1");
            Label LblProceMsg = (Label)DVGrupo.FindControl("Label13");

            if (DTWFAccionExiste.Count == 0)
            {
    ...
    protected void RadBtnLstFindby_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (this.RadBtnLstFindby.SelectedValue.ToString() == "1")
            this.AutoCompleteDepartamento.ServiceMethod = "GetWFAccionTextByTextnull";
        if (this.RadBtnLstFindby.SelectedValue.ToString() == "2")
            this.AutoCompleteDepartamento.ServiceMethod = "GetWFAccionTextByIdnull";
    }
    ...
    protected void ImgBtnUpdateActualizar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Ch.Checked == true)
        {
            ...
            this.GrupoByIdDataSource.UpdateParameters["WFAccionHabilitar"].DefaultValue = "1";
        }
        else
        {
            TextBox Txt = (TextBox)DVGrupo.FindControl("TextBox2");
    ...
    protected void ImgBtnInsert_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Ch.Checked == true)
        {
            TextBox Txt = (TextBox)DVGrupo.FindControl("TextBox2");
            Txt.Text = "1";
            this.GrupoByIdDataSource.InsertParameters["WFAccionHabilitar"].DefaultValue = "1";
        }
        else
        {
            TextBox Txt = (TextBox)DVGrupo.FindControl("TextBox2");
    ...
    protected void CheckBox2_CheckedChanged1(object sender, EventArgs e)
    {
        ...
        FormView f1 = (FormView)DVGrupo.FindControl("FVAutoNum");
        CheckBox Ch = (CheckBox)f1.FindControl("CkAuto");
        if (Ch.Checked == true)
        {
            TextBox Txt = (TextBox)DVGrupo.FindControl("TextBox1");
