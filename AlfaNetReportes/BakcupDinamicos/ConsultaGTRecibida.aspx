<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="ConsultaGTRecibida.aspx.cs" Inherits="AlfaNetReportes_Dinamicos_ConsultaGTRec" Title="Consulta Dinamica Recibido" %>
...
</asp:CheckBox> <dxpgw:ASPxPivotGridExporter id="ASPxPivotGridExporter1" runat="server" ASPxPivotGridID="ConsultaRegistros">
    </dxpgw:ASPxPivotGridExporter>
            <br />
            <DIV style="TEXT-ALIGN: center"><TABLE class="style1"><TBODY><TR><TD style="WIDTH: 173px"><dxe:ASPxComboBox id="listExportFormat" runat="server" ImageFolder="~/App_Themes/Office2003 Blue/{0}/" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" CssPostfix="Office2003_Blue" ValueType="System.String"><Items>
...
<ButtonStyle Width="13px">
    ...
    </DIV><TABLE><TBODY><TR><TD style="WIDTH: 621px"><br />
<dxwpg:ASPxPivotGrid id="ConsultaRegistros" runat="server" Width="900px" OnPreRender="ConsultaRegistros_PreRender" EnableCallBacks="False"><Fields>
