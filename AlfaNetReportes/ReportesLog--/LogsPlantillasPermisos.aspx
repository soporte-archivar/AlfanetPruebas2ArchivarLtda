<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"
    CodeFile="LogsPlantillasPermisos.aspx.cs" Inherits="_DocRecibido" %>
...
style="WIDTH: 489px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">Reporte Logs Plantillas Permisos</TD></TR><TR><TD 
...
<asp:CheckBox id="ChBActividadLogica" runat="server" Width="300px" Text="Por Actividad Logica" AutoPostBack="True" OnCheckedChanged="ChBActividadLogica_CheckedChanged"></asp:CheckBox><BR   /><asp:Label id="LblActividadLogica" runat="server" Width="60px" Visible="False" Text="Actividad Logica"></asp:Label>
    <cc1:AutoCompleteExtender id="ACEActividadLogica" runat="server" TargetControlID="TxtActividadLogica" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDataReportlogPlantillasPermisosReadActividadLogcodigo" MinimumPrefixLength="0" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem " CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc1:AutoCompleteExtender>
...
<dxwgv:GridViewDataTextColumn FieldName="plantillaCodigo" Caption="Codigo Plantilla" VisibleIndex="7">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>

<dxwgv:GridViewDataTextColumn FieldName="dependenciaCodigo" Caption="Codigo Dependencia" VisibleIndex="8">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>
...
<DataSources>
    <rsweb:ReportDataSource DataSourceId="ODSBuscarGraph" Name="DSRadicado_Radicado_ConsultasRadicado" />
             ...
             <asp:ObjectDataSource ID="ODSReporteLog4" runat="server"  SelectMethod="GetReporteLogs4" TypeName="ReporteLogBLL" OldValuesParameterFormatString="original_{0}">
                    <SelectParameters>
