...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.ODSReporteLog7.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLog7.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLog7.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLog7.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLog7";
