...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.ODSReporteLog10.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLog10.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLog10.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLog10.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLog10";
