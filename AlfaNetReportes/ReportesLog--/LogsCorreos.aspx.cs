...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            this.ODSReporteLogCorreo.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLogCorreo.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLogCorreo.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLogCorreo.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
            this.ODSReporteLogCorreo.SelectParameters["NumeroDocumento"].DefaultValue = this.TxtNumeroDocumento.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLogCorreo";
        ...
        try
        {
            ...
            else //  Generar Excel en formato .xlsx  -- JUAN FIGUEREDO 09-Sep-2020
            {
                ...
                foreach (DataColumn column in dt.Columns)
                {
                    ...
                    if (ic == 4) { column.ColumnName = "Nro.Documento"; }
                    if (ic == 5) { column.ColumnName = "Modulo"; }
                    ic++;
                }
