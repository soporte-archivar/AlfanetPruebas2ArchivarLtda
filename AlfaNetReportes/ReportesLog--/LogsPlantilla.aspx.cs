...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.ODSReporteLog3.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLog3.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLog3.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLog3.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLog3";
    ...
    protected void Export(Boolean saveAs)
    {
        ...
        try
        {
            ...
            else //  Generar Excel en formato .xlsx  -- JUAN FIGUEREDO 09-Sep-2020
            {
                ...
                //dtable = Session["DatosTable"] as DataTable;
                dtable = (DataTable)Session["DatosTable"];
                ...
                osldocument.ImportDataTable(1, 1, dtable, true);
