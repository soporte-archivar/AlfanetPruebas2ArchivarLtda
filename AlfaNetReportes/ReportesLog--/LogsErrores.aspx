<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"
    CodeFile="LogsErrores.aspx.cs" Inherits="_DocRecibido" %>
...
style="WIDTH: 489px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">Reporte Logs Errores</TD></TR><TR><TD 
...
<Settings AutoFilterCondition="Contains"></Settings>
   ...
   <%-- <dxwgv:GridViewDataTextColumn FieldName="Password" Caption="Contraseña" VisibleIndex="1" HeaderStyle-CssClass="ColumnaOculta" CellStyle-CssClass="ColumnaOculta" >
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn> --%>
...
<dxwgv:GridViewDataTextColumn FieldName="WFMovimientoFechaFin" Caption="Fecha Final" VisibleIndex="3">
<PropertiesTextEdit>
...
<DataSources>
    <rsweb:ReportDataSource DataSourceId="ODSBuscarGraph" Name="DSRadicado_Radicado_ConsultasRadicado" />
             ...
             <asp:ObjectDataSource ID="ODSReporteLog5" runat="server"  SelectMethod="GetReporteLogs5" TypeName="ReporteLogBLL" OldValuesParameterFormatString="original_{0}">
                    <SelectParameters>
