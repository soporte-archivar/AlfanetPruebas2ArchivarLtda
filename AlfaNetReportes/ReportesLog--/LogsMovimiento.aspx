<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"
    CodeFile="LogsMovimiento.aspx.cs" Inherits="_DocRecibido" %>
...
style="WIDTH: 489px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">Reporte Logs Movimiento</TD></TR><TR><TD 
...
<asp:CheckBox id="ChBFechaRad" runat="server" Width="185px" Text="Entre Fechas de Reporte" OnCheckedChanged="ChBFechaRad_CheckedChanged" AutoPostBack="True"></asp:CheckBox> <BR   /><cc1:CalendarExtender id="CalendarFinal" runat="server" TargetControlID="TxtFechaFinal" Format="dd/MM/yyyy" PopupButtonID="ImgCalendarFinal">
...
style="WIDTH: 100%; BACKGROUND-COLOR: #ffffff"><asp:UpdatePanel id="UpdatePanelNroRad" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:CheckBox ID="ChBNroRad" runat="server" Text="Por nombre de usuario" Width="181px"
                                                        OnCheckedChanged="ChBNroRad_CheckedChanged" AutoPostBack="True"   /><br   />
                                                    <asp:Label ID="LblNroRadInicial" runat="server" Text="Nombre de usuario" Visible="False"
...
style="WIDTH: 100%; BACKGROUND-COLOR: #eff3fb"><asp:UpdatePanel id="UpdatePanelDestino" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
<asp:CheckBox id="ChBDestino" runat="server" Width="300px" Text="Por Radicado o Registro ...(Seleccione un criterio)" AutoPostBack="True" OnCheckedChanged="ChBDestino_CheckedChanged"></asp:CheckBox><BR   />
                                                    <asp:RadioButtonList id="RadBtnLstNumeroDocumento" runat="server" Visible="false" Width="98px" Font-Size="Smaller" ForeColor="RoyalBlue" RepeatDirection="Horizontal" Font-Italic="False" AutoPostBack="True" OnSelectedIndexChanged="RadBtnLstNumeroDocumento_SelectedIndexChanged">
                                                            <asp:ListItem Value="1">Radicado</asp:ListItem>
                                                            <asp:ListItem Value="2">Registro</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    <asp:Label ID="LblNumeroDocumento" runat="server" Text="Numero Documento" Visible="False"
                                                        Width="60px"></asp:Label>
                                                    <cc1:AutoCompleteExtender id="AutoCompleteNumeroDocumento" runat="server" TargetControlID="TxtNumeroDocumento" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDataReportlogMovimientoAllRadNumeroDocumento" CompletionSetCount="20" MinimumPrefixLength="0" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem " CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc1:AutoCompleteExtender>
                                                    <asp:TextBox ID="TxtNumeroDocumento" runat="server" Font-Size="8pt"
                                                            Visible="False" Width="400px" CssClass="TxtAutoComplete"></asp:TextBox>
</ContentTemplate>
...
<ContentTemplate>
<asp:CheckBox id="ChBProcedencia" runat="server" Width="300px" Text="Por Actividad Logica" AutoPostBack="True" OnCheckedChanged="ChBProcedencia_CheckedChanged"></asp:CheckBox><BR   />
    <asp:Label id="LblProcedencia" runat="server" Width="60px" Visible="False" Text="Actividad Logica"></asp:Label>
     <cc1:AutoCompleteExtender id="ACEActividadLogica" runat="server" TargetControlID="TxtActividadLogica" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDataReportlogMovimientoReadActividadLogcodigo" MinimumPrefixLength="0" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem " CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc1:AutoCompleteExtender>
...
<dxwgv:GridViewDataTextColumn FieldName="WFMovimientoFechaIni" Caption="Fecha Inicial" VisibleIndex="2">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>

<dxwgv:GridViewDataTextColumn FieldName="WFMovimientoFechaFin" Width="200px" Caption="Fecha Final" VisibleIndex="3">
<PropertiesTextEdit>
...
<dxwgv:GridViewDataTextColumn FieldName="GrupoCodigo" Caption="Grupo Codigo" VisibleIndex="5">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>
...
<dxwgv:GridViewDataTextColumn FieldName="DatosIniciales" Caption="Datos Iniciales" VisibleIndex="7">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>
...
<Settings AutoFilterCondition="Contains"></Settings>
 ...
 <dxwgv:GridViewDataTextColumn FieldName="Numerodocumento" Caption="Numero Documento" VisibleIndex="9">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>
...
<DataSources>
    <rsweb:ReportDataSource DataSourceId="ODSBuscarGraph" Name="DSRadicado_Radicado_ConsultasRadicado" />
             ...
             <asp:ObjectDataSource ID="ODSReporteLog" runat="server"  SelectMethod="GetReporteLogs" TypeName="ReporteLogBLL" OldValuesParameterFormatString="original_{0}">
                    <SelectParameters>
