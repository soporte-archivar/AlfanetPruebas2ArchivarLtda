<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"  CodeFile="MainReportes.aspx.cs" Inherits="_MainConsultas" %>
        ...
        <table height="400" width="735">
            <tr>
                ...
                <td>
                    <strong></strong>
                    <h1>
                        Reportes Alfanet<strong><span style="color: appworkspace">&nbsp;</span></strong></h1>
                    <h1>
