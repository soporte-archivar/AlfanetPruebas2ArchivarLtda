...
public partial class _ReporteNaturaleza : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.NaturalezaReportViewer.LocalReport.SetParameters(parametros);
            ...
            this.NaturalezaReportViewer.LocalReport.SetParameters(new ReportParameter[] { parametro });
        }
        //LOG ACCESO
        ...
        string Datosfin1 = " Reportes Naturaleza.";
        ...
        //Insert log acceso reporte naturaleza
        DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter AccesoNatu = new DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter();
        AccesoNatu.InsertReportes(LogId, username, Fechain, ActLogCod, NumeroDocumento, GrupoCod, ModuloLog, Datosini, Datosfin1, IP, NombreEquipo, Navegador);
