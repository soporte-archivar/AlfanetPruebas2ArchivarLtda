...
public partial class _ReporteProcedencia : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.ProcedenciaReportViewer.LocalReport.SetParameters(parametros);
            ...
            this.ProcedenciaReportViewer.LocalReport.SetParameters(new ReportParameter[] { parametro });
        }
        //LOG ACCESO
        ...
        string Datosfin1 = "Reportes Procedencia.";
        ...
        //insert log repor procedencia
        DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter AccesoProced = new DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter();
        AccesoProced.InsertReportes(LogId, username, Fechain, ActLogCod, NumeroDocumento, GrupoCod, ModuloLog, Datosini, Datosfin1, IP, NombreEquipo, Navegador);
