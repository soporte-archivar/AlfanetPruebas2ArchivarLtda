...
public partial class _ReporteDependencia : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.DependenciaReportViewer.LocalReport.SetParameters(parametros);
            ...
            this.DependenciaReportViewer.LocalReport.SetParameters(new ReportParameter[] { parametro });
        }
        //LOG ACCESO
        ...
        string Datosfin1 = " Reportes Dependencia.";
        ...
        //Insert log acceso repor dependencia
        DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter AccesoDepen = new DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter();
        AccesoDepen.InsertReportes(LogId, username, Fechain, ActLogCod, NumeroDocumento, GrupoCod, ModuloLog, Datosini, Datosfin1, IP, NombreEquipo, Navegador);
