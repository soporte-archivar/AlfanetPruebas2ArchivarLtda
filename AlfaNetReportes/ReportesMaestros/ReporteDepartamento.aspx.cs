...
public partial class _ReporteDepartamento : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.DepartamentoReportViewer.LocalReport.SetParameters(parametros);
        ...
        this.DepartamentoReportViewer.LocalReport.SetParameters(new ReportParameter[] { parametro });
    }
          //LOG ACCESO
          ...
          string Datosfin1 = " Reportes Departamento.";
          ...
          //insert log acceso reporte departamento
          DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter AccesoRepDep = new DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter();
          AccesoRepDep.InsertReportes(LogId, username, Fechain, ActLogCod, NumeroDocumento, GrupoCod, ModuloLog, Datosini, Datosfin1, IP, NombreEquipo, Navegador);
