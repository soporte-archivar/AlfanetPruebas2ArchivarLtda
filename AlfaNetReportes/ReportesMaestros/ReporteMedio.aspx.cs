...
public partial class _ReporteMedio : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.MedioReportViewer.LocalReport.SetParameters(parametros);
            ...
            this.MedioReportViewer.LocalReport.SetParameters(new ReportParameter[] { parametro });
        }
        //LOG ACCESO
        ...
        string Datosfin1 = " Reportes Medio.";
        ...
        //insert log acceso reporte medio
        DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter AccesoMedio = new DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter();
        AccesoMedio.InsertReportes(LogId, username, Fechain, ActLogCod, NumeroDocumento, GrupoCod, ModuloLog, Datosini, Datosfin1, IP, NombreEquipo, Navegador);
