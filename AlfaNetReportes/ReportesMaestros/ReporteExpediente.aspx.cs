...
public partial class _ReporteExpediente : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.ExpedienteReportViewer.LocalReport.SetParameters(parametros);
            ...
            this.ExpedienteReportViewer.LocalReport.SetParameters(new ReportParameter[] { parametro });
        }
        //LOG ACCESO
        ...
        string Datosfin1 = " Reportes Expediente.";
        ...
        //Insert log acceso reporte expediente
        DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter AccesoExpe = new DSLogAlfaNetTableAdapters.LogAlfaNetTableAdapter();
        AccesoExpe.InsertReportes(LogId, username, Fechain, ActLogCod, NumeroDocumento, GrupoCod, ModuloLog, Datosini, Datosfin1, IP, NombreEquipo, Navegador);
