<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConsultaGTRecibida.aspx.cs" Inherits="AlfanetReportes_Dinamicos_ConsultaGTRecibida" %>
...
<asp:Content ID="ContentConsultaGTRecibida" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
            <asp:CheckBox id="CheckBox1" runat="server" Width="243px" Text="Graficar los Valores de las Filas" OnCheckedChanged="CheckBox1_CheckedChanged" AutoPostBack="True">
            </asp:CheckBox>
                ...
                <tbody>
                    <tr>
                        <td style="WIDTH: 621px">
                            <br />
                            <dxwpg:ASPxPivotGrid id="ConsultaRegistros" runat="server" Width="900px" OnPreRender="ConsultaRegistros_PreRender" EnableCallBacks="False">
                                <Fields>
                                    <dxwpg:PivotGridField FieldName="RadicadoCodigo" ID="fieldRadicadoCodigo" Area="FilterArea" AreaIndex="0" 
                                            Caption="Radicado" SummaryType="Count">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="WFMovimientoFecha" ID="fieldWFMovimientoFecha" Area="ColumnArea" AreaIndex="0" 
                                            GroupInterval="DateMonth" UnboundFieldName="fieldWFMovimientoFecha" Caption="Fecha Radicado"></dxwpg:PivotGridField>
                                    ...
                                    <dxwpg:PivotGridField FieldName="DependenciaNombre" ID="fieldDependenciaNombre" Area="FilterArea" AreaIndex="2" 
                                            Visible="False" Caption="Dependencia">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="Respuesta" ID="fieldRespuesta" Area="FilterArea" AreaIndex="0" Visible="False">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="WFAccionNombre" ID="fieldWFAccionNombre" Area="FilterArea" AreaIndex="2" 
                                            Visible="False" Caption="Accion">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="ExpedienteNombre" ID="fieldExpedienteNombre" Area="FilterArea" AreaIndex="2" Caption="Expediente">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="SerieNombre" ID="fieldSerieNombre" Area="FilterArea" AreaIndex="3" Caption="Serie">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="NaturalezaNombre" ID="fieldNaturalezaNombre" Area="RowArea" AreaIndex="0" Caption="Naturaleza">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="RadicadoCodigo" ID="fieldRadicadoCodigo2" Area="DataArea" AreaIndex="0" 
                                            Caption="Radicado Codigo Pivot" SummaryType="Count">
                                    </dxwpg:PivotGridField>
                                    <dxwpg:PivotGridField FieldName="WFMovimientoFecha" ID="fieldYearGT" Area="ColumnArea" AreaIndex="0" 
                                            Visible="False" GroupInterval="DateYear" UnboundFieldName="field" Caption="A&#241;os Radicado">
                                    </dxwpg:PivotGridField>
                                </Fields>
                                ...
                                <OptionsChartDataSource ShowColumnCustomTotals="False" ShowColumnGrandTotals="False" ShowColumnTotals="False" 
                                        ShowRowCustomTotals="False" ShowRowGrandTotals="False" ShowRowTotals="False">
            ...
            <asp:SqlDataSource id="AlfaWeb" runat="server" SelectCommand="Radicado_ConsultasGestionTareasDinamico" 
            ...
            <dxchartsui:WebChartControl style="TEXT-ALIGN: center" id="WebChartControl1" runat="server" Width="900px" 
                ...
                <SeriesSerializable>
                    <cc2:Series Name="Series 1" ArgumentScaleType="Numerical" LabelTypeName="SideBySideBarSeriesLabel" 
