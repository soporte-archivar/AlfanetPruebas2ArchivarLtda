...
public partial class AlfanetReportes_Dinamicos_ConsultaGTRecibida : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            this.ConsultaRegistros.DataSourceID = "AlfaWeb";
            // Create chart titles.
            ChartTitle chartTitle1 = new ChartTitle();
            //this.
            // Define the text for the titles.
            chartTitle1.Text = "<color=blue>Grafico Dinamico Gestion de Tareas Correspondencia Recibida</color>";

            this.ConsultaRegistros.OptionsChartDataSource.ChartDataVertical = false;
