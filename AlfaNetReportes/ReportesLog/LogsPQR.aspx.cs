...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.ODSReporteLog8.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLog8.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLog8.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLog8.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLog8";
