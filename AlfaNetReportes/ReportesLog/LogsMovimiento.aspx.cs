...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void ChBDestino_CheckedChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.AutoCompleteNumeroDocumento.ServiceMethod = "GetDataReportlogMovimientoAllRadNumeroDocumento";
        }
    }
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.ODSReporteLog.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLog.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLog.SelectParameters["username"].DefaultValue = this.TxtNroRadInicial.Text;
            this.ODSReporteLog.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadLogica.Text;
            this.ODSReporteLog.SelectParameters["GrupoCodigo"].DefaultValue = this.RadBtnLstNumeroDocumento.SelectedValue.ToString();
            this.ODSReporteLog.SelectParameters["NumeroDocumento"].DefaultValue = this.TxtNumeroDocumento.Text;
        ...
        {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLog";
    ...
    //Radiobuton para elegir que procedimiento utlizar en el autocomplete
    protected void RadBtnLstNumeroDocumento_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            this.AutoCompleteNumeroDocumento.ServiceMethod = "GetDataReportlogMovimientoRadNumeroDocumento";
            //this.TxtNumeroDocumento.Text = "";
        }
        else if (RadBtnLstNumeroDocumento.SelectedValue == "2")
        {
            this.AutoCompleteNumeroDocumento.ServiceMethod = "GetDataReportlogMovimientoRadNumeroDocumento2";
            // this.TxtNumeroDocumento.Text = "";
        }
