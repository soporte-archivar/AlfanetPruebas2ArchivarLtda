...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    /*protected void ChBGrupocodigo_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            this.RadioButtonList2.Visible = false;
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (TxtFechaInicial.Text != "" && TxtFechaInicial.Text != string.Empty && TxtFechaFinal.Text != "" && TxtFechaFinal.Text != string.Empty)
            //{
            //    DateTime inicial = Convert.ToDateTime(TxtFechaInicial.Text);
            //    TxtFechaInicial.Text = inicial.ToString("yyyy/MM/dd 00:00:01");

            //    DateTime final = Convert.ToDateTime(TxtFechaFinal.Text);
            //    TxtFechaFinal.Text = inicial.ToString("yyyy/MM/dd");

            //}
            this.ODSReporteLog6.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLog6.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLog6.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLog6.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLog6";
