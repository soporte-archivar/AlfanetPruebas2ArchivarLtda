...
<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"
    CodeFile="LogsCorreos.aspx.cs" Inherits="_DocRecibido" %>
...
style="WIDTH: 489px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">Reporte Logs Correo</TD></TR><TR><TD 
...
<cc1:AutoCompleteExtender id="ACEActividadLogica" runat="server" TargetControlID="TxtActividadLogica" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDataReportlogCorreo_ReadActividadLogcodigo" MinimumPrefixLength="0" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem " CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc1:AutoCompleteExtender>
...
<TR><TD 
style="WIDTH: 100%; BACKGROUND-COLOR: #eff3fb"><asp:UpdatePanel id="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
...
<Settings AutoFilterCondition="Contains"></Settings>
    ...
    <dxwgv:GridViewDataTextColumn FieldName="HostCorreo" Caption="Host Correo" VisibleIndex="10">
<Settings AutoFilterCondition="Contains"></Settings>
</dxwgv:GridViewDataTextColumn>
...
<DataSources>
    <rsweb:ReportDataSource DataSourceId="ODSBuscarGraph" Name="DSRadicado_Radicado_ConsultasRadicado" />
             ...
             <asp:ObjectDataSource ID="ODSReporteLogCorreo" runat="server"  SelectMethod="GetReporteLogCorreo" TypeName="ReporteLogBLL" OldValuesParameterFormatString="original_{0}">
                    <SelectParameters>
