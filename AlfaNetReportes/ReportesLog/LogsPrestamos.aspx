...
<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"
    CodeFile="LogsPrestamos.aspx.cs" Inherits="_DocRecibido" %>
...
style="WIDTH: 489px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">Reporte Logs Prestamos</TD></TR><TR><TD 
...
<asp:CheckBox id="ChBActividadLogica" runat="server" Width="300px" Text="Por Actividad Logica" AutoPostBack="True" OnCheckedChanged="ChBActividadLogica_CheckedChanged"></asp:CheckBox><BR   /><asp:Label id="LblActividadLogica" runat="server" Width="60px" Visible="False" Text="Actividad Logica"></asp:Label>
 <cc1:AutoCompleteExtender id="ACEActividadLogica" runat="server" TargetControlID="TxtActividadLogica" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDataReportlogPrestamos_ReadActividadLogcodigo" MinimumPrefixLength="0" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem " CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></cc1:AutoCompleteExtender>
...
<DataSources>
    <rsweb:ReportDataSource DataSourceId="ODSBuscarGraph" Name="DSRadicado_Radicado_ConsultasRadicado" />
             ...
             <asp:ObjectDataSource ID="ODSReporteLog9" runat="server"  SelectMethod="GetReporteLogs9" TypeName="ReporteLogBLL" OldValuesParameterFormatString="original_{0}">
                    <SelectParameters>
