...
public partial class _DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            this.ODSReporteLogReportes.SelectParameters["fechaini"].DefaultValue = this.TxtFechaInicial.Text;
            this.ODSReporteLogReportes.SelectParameters["fechafin"].DefaultValue = this.TxtFechaFinal.Text;
            this.ODSReporteLogReportes.SelectParameters["username"].DefaultValue = this.TxtUsername.Text;
            this.ODSReporteLogReportes.SelectParameters["ActividadLogica"].DefaultValue = this.TxtActividadlogica.Text;
            this.ODSReporteLogReportes.SelectParameters["NumeroDocumento"].DefaultValue = this.TxtNumeroDocumento.Text;
          ...
          {*/
            ...
            ASPxGridView1.DataSourceID = "ODSReporteLogReportes";
            //ReportViewer1.LocalReport.DataSources[0].DataSourceId = "";
            ASPxGridView1.DataBind();

            // Siguiente codigo para duplicar la información del Datasource  -- JUAN FIGUEREDO 09-Sep-2020
            ...
            //Fin duplicado de informacion datasource, se utilizará posteriormente para Generar Excel
            /*}
            else
            {
    ...
    protected void Export(Boolean saveAs)
    {
        ...
        try
        {
            ...
            else //  Generar Excel en formato .xlsx  -- JUAN FIGUEREDO 11-Sep-2020
            {
                ...
                foreach (DataColumn column in dt.Columns)
                {
                    ...
                    if (ic == 2) { column.ColumnName = "Fecha"; }
                    if (ic == 3) { column.ColumnName = "Actividad"; }
                    if (ic == 4) { column.ColumnName = "Modulo"; }
                    ic++;
                }
