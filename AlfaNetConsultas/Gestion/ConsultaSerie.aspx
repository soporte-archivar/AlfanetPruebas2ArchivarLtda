<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConsultaSerie.aspx.cs" Inherits="AlfaNetConsultas_Gestion_ConsultaSerie" %>
...
<asp:Content ID="ContentConsultaSerie" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center" colspan="2" style="height: 45px; background-color: highlighttxt">
                                                <br />
                                                <asp:Label ID="LblMessageBox" runat="server" Font-Size="XX-Large" ForeColor="Red">
                                                </asp:Label>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <Panes>
                                    ...
                                    <table style="WIDTH: 100%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="HEIGHT: 318px" colspan="3">
                                                    <asp:UpdatePanel id="UpdatePanelExpediente" runat="server" RenderMode="Inline">
                                                        <ContentTemplate>
                                                            <table style="WIDTH: 600px; TEXT-ALIGN: left" forecolor="White">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="WIDTH: 600px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">
                                                                            Consulta de Documentos por Serie
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="WIDTH: 600px; BACKGROUND-COLOR: #eff3fb; TEXT-ALIGN: center" colspan="3">
                                                                            <table style="WIDTH: 100%; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; 
                                                                                    BORDER-BOTTOM-STYLE: none" border="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="WIDTH: 57px; HEIGHT: 8px">
                                                                                            <strong>
                                                                                                <em>
                                                                                                    <span style="FONT-FAMILY: Poor Richard">
                                                                                                    </span>
                                                                                                </em>
                                                                                            </strong>
                                                                                            <asp:Label id="LblFindBy" runat="server" Width="84px" 
                                                                                                    Font-Size="Smaller" ForeColor="RoyalBlue" Text="Buscar Por: " 
                                                                                                    Font-Bold="True" BorderStyle="None">
                                                                                            </asp:Label>
                                                                                        </td>
                                                                                        <td style="VERTICAL-ALIGN: middle; WIDTH: 115px; HEIGHT: 8px; TEXT-ALIGN: center">
                                                                                            <asp:RadioButtonList id="RadBtnLstFindby" runat="server" Width="106px" 
                                                                                                    Font-Size="Smaller" ForeColor="RoyalBlue" RepeatDirection="Horizontal" 
                                                                    ...
                                                                    <tr>
                                                                        <td style="WIDTH: 489px; HEIGHT: 16px; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: center">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="WIDTH: 489px; BACKGROUND-COLOR: #eff3fb; TEXT-ALIGN: center">
                                                                            &nbsp;
                                                                            <asp:CheckBox id="CBBusquedaExacta" runat="server" Font-Size="Smaller" Visible="False" 
                                                                                    ForeColor="RoyalBlue" Text="Busqueda Exacta" Font-Bold="True">
                                                                            </asp:CheckBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="WIDTH: 100%; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: center">
                                                                            <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" 
                                                                                    Width="6px" ValidationGroup="ValGroup1" SetFocusOnError="True" 
                                                                                    ErrorMessage="RequiredFieldValidator" ControlToValidate="TxtExpediente">
                                                                                *
                                                                            </asp:RequiredFieldValidator>
                                                                            <asp:Label id="LblExpedienteS" runat="server" Width="100px" BackColor="CornflowerBlue" 
                                                                                    ForeColor="White" Text="Serie" Font-Bold="True" BorderStyle="Solid" BorderWidth="2px" 
                                                                                    BorderColor="#B5C7DE">
                                                                            </asp:Label>
                                                                            <asp:TextBox id="TxtExpediente" runat="server" Width="350px" CssClass="TxtAutoComplete">
                                                                            </asp:TextBox>
                                                                            <asp:ImageButton id="ImgBtnFind" onclick="ImgBtnFind_Click" runat="server" 
                                                                                    ImageUrl="~/AlfaNetImagen/ToolBar/zoom.png" CommandName="Select">
                                                                            </asp:ImageButton>
                                                                            <asp:HiddenField id="HFDependenciaConsulta" runat="server">
                                                                            </asp:HiddenField>
                                                                            <asp:HiddenField id="HFCodigoSeleccionado" runat="server">
                                                                            </asp:HiddenField>
                                                                            <cc1:autocompleteextender id="ACExpediente" runat="server" 
                                                                                    CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" 
                                                                                    CompletionListItemCssClass="autocomplete_listItem " 
                                                                                    CompletionListCssClass="autocomplete_completionListElement" 
                                                                                    targetcontrolid="TxtExpediente" servicepath="../../AutoComplete.asmx" 
                                                                                    servicemethod="GetSerieByText" minimumprefixlength="1" enablecaching="true" 
                                                                                    completionsetcount="12" completioninterval="1000" ContextKey="311">
                                                                            </cc1:autocompleteextender>
                                                                            <cc1:TextBoxWatermarkExtender id="TBWExpediente1" watermarkText="Seleccione una Serie ..." 
                                                                                    runat="server" TargetControlID="TxtExpediente">
                                                                            </cc1:TextBoxWatermarkExtender>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="WIDTH: 485px; BACKGROUND-COLOR: #eff3fb; TEXT-ALIGN: center">
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="WIDTH: 500px; COLOR: white; HEIGHT: 21px; BACKGROUND-COLOR: #507cd1">
                                                                            &nbsp;
                                                                            <asp:ImageButton id="ImgBtnNew" onclick="ImgBtnNew_Click" runat="server" 
                                                                                    ImageUrl="~/AlfaNetImagen/ToolBar/Add.png">
                                                                            </asp:ImageButton>
                                                                            &nbsp;
                                                                            <asp:ImageButton id="ImgBtnCancel" runat="server" ImageUrl="~/AlfaNetImagen/ToolBar/cross.png">
                                                                            </asp:ImageButton>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <dxwgv:aspxgridview id="ASPxGridView1" runat="server" Width="100%" datasourceid="ODSBuscar" 
                                                            csspostfix="Office2003_Blue" cssfilepath="~/App_Themes/Office2003 Blue/{0}/styles.css" 
                                                            autogeneratecolumns="False" KeyFieldName="SerieCodigo">
                                                        <Styles CssPostfix="Office2003_Blue" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css">
                                                            <Header SortingImageSpacing="5px" ImageSpacing="5px"></Header>
                                                            <LoadingPanel ImageSpacing="10px"></LoadingPanel>
                                                        </Styles>

                                                        <SettingsLoadingPanel Text="Cargando&amp;hellip;" ShowImage="False">
                                                        ...
                                                        <Columns>
                                                            <dxwgv:GridViewDataTextColumn FieldName="SerieCodigoPadre" GroupIndex="0" SortIndex="0" SortOrder="Ascending" 
                                                                    Caption="Serie Padre" VisibleIndex="0">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn FieldName="SerieCodigo" ReadOnly="True" VisibleIndex="1">
                                                                <DataItemTemplate>
                                                                    <asp:LinkButton id="LBtnExpediente" onclick="LBtnExpediente_Click" runat="server" Width="40px" 
                                                                            Text='<%# Bind("SerieCodigo") %>' CommandName="Select">
                                                                    </asp:LinkButton>
                                                                </DataItemTemplate>
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn FieldName="SerieNombre" VisibleIndex="2">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn FieldName="SerieTiempo" Caption="Tiempo" VisibleIndex="3">
                                                            </dxwgv:GridViewDataTextColumn>
                                                        </Columns>
                            ...
                            <cc1:AccordionPane ID="AccordionPane2" runat="server" ContentCssClass="" HeaderCssClass="">
                                ...
                                <Content>
                                    ...
                                    <dxwgv:aspxgridview id="ASPxGVExpediente" runat="server" Width="100%" csspostfix="Office2003_Blue" 
                                            cssfilepath="~/App_Themes/Office2003 Blue/{0}/styles.css" autogeneratecolumns="False" 
                                            OnHtmlRowPrepared="ASPxGVExpediente_HtmlRowPrepared">
                                        <Styles CssPostfix="Office2003_Blue" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css">
                                            <Header SortingImageSpacing="5px" ImageSpacing="5px"></Header>
                                            <LoadingPanel ImageSpacing="10px"></LoadingPanel>
                                        </Styles>
                                        ...
                                        <Columns>
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="NroDoc" Caption="Nro Documento" VisibleIndex="1">
                                                <DataItemTemplate>
                                                    <asp:HyperLink id="HyperLink1" runat="server" Font-Size="XX-Small" Text='<%# Eval("NroDoc") %>' 
                                                            Font-Underline="True" CssClass="LinKBtnStyleBig">
                                                    </asp:HyperLink>
                                                </DataItemTemplate>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataDateColumn FieldName="WFMovimientoFecha" Caption="Fecha" VisibleIndex="3">
                                            </dxwgv:GridViewDataDateColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="Detalle" VisibleIndex="4">
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="GrupoNombre" Caption="Grupo" VisibleIndex="2">
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="SerieNombre" Caption="Serie" VisibleIndex="5">
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="6" Caption="Opciones">
                                                <DataItemTemplate>
                                                    <asp:HyperLink id="HprLnkImgExtVen" runat="server" Font-Size="XX-Small" Text="Imagenes" 
                                                            Font-Underline="True" CssClass="LinKBtnStyleBig">
                                                    </asp:HyperLink> 
                                                </DataItemTemplate>
                                            </dxwgv:GridViewDataTextColumn>
            ...
            <tr>
                <td>
                    ...
                    <asp:ValidationSummary Style="vertical-align: middle; text-align: float" ID="ValidationSummaryRadicado"
                            runat="server" Width="418px" Height="1px" Font-Size="10pt" DisplayMode="List">
