...
public partial class AlfaNetConsultas_Gestion_DocRecibido : System.Web.UI.Page
{
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            this.ODSBuscarGraph.SelectParameters["WFMovimientoFecha"].DefaultValue = TxtFechaInicial.Text.Length>0 ? Convert.ToDateTime(this.TxtFechaInicial.Text).Year+"/"+Convert.ToDateTime(this.TxtFechaInicial.Text).Month+"/"+Convert.ToDateTime(this.TxtFechaInicial.Text).Day:string.Empty;
            this.ODSBuscarGraph.SelectParameters["WFMovimientoFecha1"].DefaultValue = TxtFechaFinal.Text.Length > 0 ? Convert.ToDateTime(this.TxtFechaFinal.Text).Year+"/"+Convert.ToDateTime(this.TxtFechaFinal.Text).Month+"/"+Convert.ToDateTime(this.TxtFechaFinal.Text).Day:string.Empty;
