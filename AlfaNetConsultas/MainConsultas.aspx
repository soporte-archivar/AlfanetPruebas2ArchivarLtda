<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"  CodeFile="MainConsultas.aspx.cs" Inherits="_MainConsultas" %>
    ...
    <div style="text-align: center">
        <table height="400" width="735">
            <tr>
                ...
                <td>
                    <strong></strong>
                    <h1>Consultas Alfanet
                        <strong><span style="color: appworkspace">CONSULTAS&nbsp;</span></strong></h1>
                    <h1>
