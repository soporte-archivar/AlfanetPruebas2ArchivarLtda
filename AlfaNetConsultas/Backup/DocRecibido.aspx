<%@ Page Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true"
    CodeFile="DocRecibido.aspx.cs" Inherits="_DocRecibido" %>
                ...
                <cc1:Accordion ID="MyAccordion" runat="server" Width="100%" TransitionDuration="250"
                    ...
                    <Panes>
                        <cc1:AccordionPane ID="AccordionPane1" Font-Size="medium" runat="server" ContentCssClass="" HeaderCssClass="">
                            <Header>
                                <a class="accordionLink" href="">Documentos Recibidos.:</a>
                            </Header>
                            <Content>
                             <TABLE style="WIDTH: 100%; TEXT-ALIGN: left" 
forecolor="White"><TBODY><TR><TD 
style="WIDTH: 489px; COLOR: white; HEIGHT: 16px; BACKGROUND-COLOR: #507cd1; TEXT-ALIGN: center">Consulta de Correspondencia 
...
<asp:CheckBox id="ChBFechaRad" runat="server" Width="185px" Text="Entre Fechas de Radicacion" OnCheckedChanged="ChBFechaRad_CheckedChanged" AutoPostBack="True"></asp:CheckBox> <BR   /><cc1:CalendarExtender id="CalendarFinal" runat="server" TargetControlID="TxtFechaFinal" Format="dd/MM/yyyy" PopupButtonID="ImgCalendarFinal">
...
<NodeStyle HorizontalPadding="5px" NodeSpacing="0px" VerticalPadding="0px" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black"></NodeStyle>
                                                        </asp:TreeView> <asp:TreeView id="TreeVSerie" runat="server" Width="300px" Visible="False" ShowLines="True" ExpandDepth="0">
<ParentNodeStyle Font-Bold="False"></ParentNodeStyle>
...
<NodeStyle HorizontalPadding="5px" NodeSpacing="0px" VerticalPadding="0px" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black"></NodeStyle>
                                                        </asp:TreeView> <asp:TreeView id="TreeVProceso" runat="server" Width="300px" Visible="False" ShowLines="True" ExpandDepth="0">
<ParentNodeStyle Font-Bold="False"></ParentNodeStyle>
...
style="WIDTH: 100%; HEIGHT: 17px; BACKGROUND-COLOR: #eff3fb" colSpan=3><asp:UpdatePanel id="UpdatePanelNaturaleza" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
<asp:CheckBox id="ChBNaturaleza" runat="server" Width="250px" Text="Por Naturaleza ...(Seleccione o ingrese criterio)" AutoPostBack="True" OnCheckedChanged="ChBNaturaleza_CheckedChanged"></asp:CheckBox><BR   /><asp:Label id="LblNaturaleza" runat="server" Width="60px" Visible="False" Text="Naturaleza"></asp:Label><cc1:AutoCompleteExtender id="AutoCompleteNaturaleza" runat="server" TargetControlID="TxtBNaturaleza" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_listItem " CompletionListCssClass="autocomplete_completionListElement" MinimumPrefixLength="1" ServiceMethod="GetNaturalezaByTextNull" ServicePath="../../AutoComplete.asmx"></cc1:AutoCompleteExtender> <cc1:PopupControlExtender id="PopupControlNaturaleza" runat="server" PopupControlID="PnlNaturaleza" TargetControlID="TxtBNaturaleza" Position="Right">
...
<ButtonStyle Width="13px"></ButtonStyle>
                    ...
                    </dxe:ASPxButton> </TD><TD style="WIDTH: 65px"><dxe:ASPxButton id="ButtonSaveAs" onclick="ButtonSaveAs_Click" runat="server" Text="Guardar" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" CssPostfix="Office2003_Blue">
                    </dxe:ASPxButton> </TD></TR></TBODY></TABLE><dxpc:ASPxPopupControl id="popup" runat="server" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" CssPostfix="Office2003_Blue" ImageFolder="~/App_Themes/Office2003 Blue/{0}/" ClientInstanceName="popup" AllowDragging="True" PopupHorizontalAlign="OutsideRight" HeaderText="Vinculo a Respuesta">
